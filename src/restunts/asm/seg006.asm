...
loc_24DEC:
    ...
    mov     poly_linklist_40ED6_iter2, 600
    retf
    ; align 2
    db 144
polyinfo_reset endp
...
loc_24F9F:
    ...
    jmp     loc_250A3       ; initialized to 600 in polyinfo_reset()
loc_24FB6:
    sub     ax, ax
    push    ax
    mov     bx, [bp+arg_transshapeptr]
...
loc_250A3:
    mov     ax, poly_linklist_40ED6_iter2  ; initialized to 600 in polyinfo_reset()
