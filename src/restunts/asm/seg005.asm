...
loc_21FF6:
    ...
    jmp     short loc_22020
loc_2201A:
    mov     height_above_replaybar, 0C8h ; '�'; 200 = height of render area without the replay menu bar
loc_22020:
    mov     byte_449E2, 1
...
loc_24242:
    ...
    ;jge     short loc_241F9
    jg      short loc_241F9
    add     custom_camera_elevation_angle, 4h
    pop     si
    pop     di
    mov     sp, bp
    pop     bp
...
loc_24258:
    ...
    cmp     ax, 0FF00h
    jle     short loc_241F9
    sub     custom_camera_elevation_angle, 4h
    pop     si
    pop     di
    mov     sp, bp
    pop     bp
